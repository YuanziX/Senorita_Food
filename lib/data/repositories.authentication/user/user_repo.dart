...
class UserRepository extends GetxController {
  ...
  // Function to fetch user deatails based on User ID
  Future<UserModel> fetchUserDeatails() async {
    try {
  ...
  Future<void> updateUserDeatails(UserModel updatedUser) async {
    try {
      await _db
          .collection("Users")
          .doc(updatedUser.id)
  ...
  // Function to remove userdata from fire store
